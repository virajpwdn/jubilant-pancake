...
In school, I was also pretty good - I used to score **95% or above** with pretty much _no effort_, tbh. Homework I used to complete in school itself, and I used to be free at home. My family used to say
...
Then **January 2024** happened. The company decided to go **offline-only**. I was devastated - this job had become my _identity_, my proof that I could actually build things. And due to my collage i cannot join the offline-only job.
...
So I started applying again, landed a job at **Upsurge Labs**, worked on **BhindiAI** product as a backend dev, and moved to **Bangalore**.
...
But none of this happened managing a side project and job also collage because I was not naturally organized or had some secret productivity hack.
